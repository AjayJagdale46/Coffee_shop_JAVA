...
// ImageIcon aa=new ImageIcon(".jpg");
// JLabel fa=new JLabel(new ImageIcon("5.jpg"));
//              setVisible(true);
//              setSize(1920,1080);
...
// b1.setBounds( 150,500,500,99);
// b2.setBounds( 900,500,500,99);
// b3.setBounds( 500,700,500,99);
...
// 				//JOptionPane.showMessageDialog(null,"MENU BAR");
// 			Menu m=new Menu();
// 			setVisible(false);}
...
// 		if(ae.getSource()==b2)
// 		{
// 		//	JOptionPane.showMessageDialog(null,"TABLE  Booking");
// 			table t= new table();
// 		}
// 		if(ae.getSource()==b3)
// 		{
